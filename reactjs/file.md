...
- [Steps to Install](#steps-to-install)  
  - [1. Install PostgreSQL](#1-install-postgresql)  
    ...
    - [1.3 Verify PostgreSQL Installation](#13-verify-postgresql-installation)  
    - [1.4 Start & Enable PostgreSQL Service](#14-start-and-enable-postgresql-service)  
    - [1.5 Switch to PostgreSQL User](#15-switch-to-postgresql-user)  
    - [1.6 Access PostgreSQL Shell](#16-access-postgresql-shell)  
    - [1.7 Connect PostgreSQL via Private IP](#17-connect-postgresql-via-private-ip)  
...
## 3. Install Liquibase (Database Change Management)
➔ **Installation Steps:**
